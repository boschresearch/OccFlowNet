...
model = dict(
    ...
    loss_occ_density=dict(
        type='MMBCELoss',
        loss_weight=1.0),
    loss_occ_semantics=dict(
...
train_pipeline = [
    ...
    dict(type='LoadFlowGT', render_frame_ids=render_frame_ids, data_root=flow_root),
    dict(type='DefaultFormatBundle3D', class_names=class_names),
    dict(type='Collect3D', keys=['img_inputs', 'gt_depth','voxel_semantics', 'mask_lidar','mask_camera', 'origins', 'directions', 'ray_dataset', 'voxel_flow'])
]
