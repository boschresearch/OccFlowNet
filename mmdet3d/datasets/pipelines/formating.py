...
class DefaultFormatBundle(object):
    ...
    def __call__(self, results):
        ...
        if 'origins' in results:
            ...
            results['directions'] = DC(results['directions'])
            results['ray_dataset'] = DC(results['ray_dataset'])
            results['coor'] = DC(results['coor'])
        if 'voxel_flow' in results:
            results['voxel_flow'] = DC(results['voxel_flow'])
        if 'flow_transforms' in results:
            results['flow_transforms'] = DC(results['flow_transforms'])
